...
The project has been split in 3 branches. Each one represents the code to be uploaded to each node. This is the code for the ECU carrying the sensor hardware.